...
export default (function () {
    ...
    r = n(
        ...
        "http://cdn.asprise.com/scanapp/scan-setup.html"
    );
    ...
    window.scannerjs.getUploadResponse = function (a, b) {
        if ("string" === typeof a) {
            if (6 < a.length && "<error" == a.substr(0, 6)) throw a;
            try {
                a = JSON.parse(a);
        ...
        if ("object" === typeof a && a.output instanceof Array) {
            ...
            for (var c = 0; c < a.length; c++) {
                var d = a[c];
                if (
                    ("upload" == d.type || "upload-thumbnail" == d.type) &&
                    d.result instanceof Array &&
                    0 < d.result.length &&
                    !b
                )
                    return d.result[0];
