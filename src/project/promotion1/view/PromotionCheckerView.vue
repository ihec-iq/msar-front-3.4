...
const headers = ref<Array<ITableHeader>>([
  ...
  { caption: t("Promotion.difNextBonusDate"), value: "difNextBonusDateShow" }, // Updated for promotion
    ...
    <IPageContent>
      <IRow :cols="3" :cols-md="2" :cols-lg="3">
        <ISearchBar :getDataButton="getFilterData">
          ...
          <ICol :span-lg="1" :span-md="2" :span="1">
            <ICheckbox
              :label="
                t('Promotion.IsBoundFilter') +
                ' ' +
                SettingNumberDayesAlertPromotion.valInt +
                ' ' +
                t('Day')
              "
      ...
      <IRow>
        <ITable :items="data" :headers="headers">
          <template v-slot:difNextBonusDateShow="{ row }">
