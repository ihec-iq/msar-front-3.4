...
const headers = ref<Array<ITableHeader>>([
  ...
  { caption: t("Bonus.dateLastBonus"), value: "current.dateBonus" },
  { caption: t("Bonus.difNextBonusDate"), value: "next.difBonusDate" },
  { caption: t("Bonus.dateNextBonus"), value: "next.dateBonus" },
...
const drowRow = (row: IBonusEmployeeTotal): string => {
  ...
  for (let i = 0; i < length; i++) {
    ...
    //const element = row.getBonusEmployeeTotal[i];
        ...
        <div id="printMe" class="[print-color-adjust:exact] p-1">
          <div class="overflow-auto">
            ...
            <table class="table-fixed text-sm w-[1040px]" dir="rtl">
              <thead>
                <tr class="bg-gray-300 border-t-2 border-black">
                  <th class="tdborderx w-[30px]">ت</th>
                  <th class="tdborderx w-[80px]">الاسم</th>
                  <th class="tdborderx w-[70px]">المكتب</th>
                  <th class="tdborderx w-[50px]">القسم</th>
                  <th class="tdborderx w-[60px]">التحصيل الدراسي</th>
                  <th class="tdborderx w-[60px]">الشهادة الدراسية</th>
                  <th class="tdborderx w-[60px]">العنوان الوظيفي</th>
                ...
                <tr class="bg-gray-300">
                  ...
                  <th class="tdborderx w-[80px]"></th>
                  <th class="tdborderx w-[70px]"></th>
                  <th class="tdborderx w-[50px]"></th>
