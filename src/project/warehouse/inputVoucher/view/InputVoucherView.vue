        ...
        <IForm>
          <IRow col-lg="4" col-md="2" col-sm="1">
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('InputVoucher.Number')" name="InputVoucher.Number" v-model="inputVoucher.number"
                :type="EnumInputType.Text" />
            </ICol>
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('Date')" name="InputVoucher.Date" v-model="inputVoucher.date"
                :type="EnumInputType.Date" />
            </ICol>
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('InputVoucher.DateReceive')" name="InputVoucher.DateReceive"
                v-model="inputVoucher.dateReceive" :type="EnumInputType.Date" />
            </ICol>
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('InputVoucher.DateBill')" name="InputVoucherNumer" v-model="inputVoucher.dateBill"
                :type="EnumInputType.Date" />
            </ICol>
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('InputVoucher.NumberBill')" name="InputVoucher.NumberBill"
            ...
            <ICol span="1" span-md="2" span-sm="1">
              <ISelect :label="t('InputVoucher.State')" v-model="inputVoucher.State.id" name="inputVoucherStateId"
