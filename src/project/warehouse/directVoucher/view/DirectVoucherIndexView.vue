...
import type { IDirectVoucher, IDirectVoucherFilter } from "../IDirectVoucher";
...
import CardDirectVoucherIndex from "./CardDirectVoucherIndex.vue";
...
<template>
  <IPage :HeaderTitle="t('DirectVoucher.Index')" :is-loading="isLoading">
    ...
    <IPageContent>
      ...
      <IRow :col="4" :col-lg="4" :col-md="3" :col-sm="1" :col-xs="1">
        ...
        >
          <!-- card -->
          <CardDirectVoucherIndex :item="item" />
          <!-- end card -->
        </ICol>
      </IRow>
      <!-- Pagination -->
