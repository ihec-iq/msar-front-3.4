  ...
  <IPage :HeaderTitle="t(namePage)" :isLoading="Loading">
        ...
        <IForm>
          <IRow col-lg="4" col-md="2" col-sm="1">
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('OutputVoucherNumber')" name="Number" v-model="outputVoucher.number"
                :type="EnumInputType.Text" />
            </ICol>
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('Date')" name="InputVoucherNumer" v-model="outputVoucher.date"
            ...
            <ICol span="1" span-md="2" span-sm="1">
              <IInput :label="t('InputVoucherSignaturePerson')" name="InputVoucherNumer"
                v-model="outputVoucher.signaturePerson" :type="EnumInputType.Text" />
            </ICol>
          </IRow>
          <IRow col-lg="4" col-md="2" col-sm="1">
            <ICol :span="1" span-lg="1" span-xl="1" span-md="1">
              <div class="mb-2">
                ...
                <select v-model="outputVoucher.Stock" class="_input" @change="ChangeStock()">
            ...
            <ICol span="3">
              <IInput :label="t('Notes')" name="InputVoucherNumer" v-model="outputVoucher.notes"
                :type="EnumInputType.Text" />
            </ICol>
          </IRow>
          <IRow>
    ...
    <IContainer class="w-full">
      <van-popup class="overflow-hidden dark:bg-darkNav" v-model:show="showPop" round position="bottom">
        ...
        <div class="flex p-2" v-if="OutputVoucherItem.InputVoucherItem != null">
          ...
          <div class="w-1/4">
            <IInput :label="t('Count')" :on-input="ChangeValueTotal" :type="EnumInputType.Number"
              v-model="OutputVoucherItem.count" :max="
        ...
        <IRow>
          <ICol>
            <IInput :label="t('Note')" :type="EnumInputType.Text" v-model="OutputVoucherItem.notes" />
          </ICol>
        </IRow>
        <!-- buttons -->
