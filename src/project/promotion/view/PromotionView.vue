...
const showData = async () => {
  await PromotionStore.show(id.value)
    .then((response) => {
      if (response.status === 200) {
      ...
      <IRow>
        ...
        >
          <ICol span="1" span-md="2" span-sm="4">
            <IInput
              :label="t('Promotion.JobTitle')"
              name="JobTitle"
              disabled
              v-model="Promotion.Employee.BonusJobTitle.name"
              :type="EnumInputType.Text"
            />
          </ICol>
          <ICol span="1" span-md="1" span-sm="1">
            <IInput
              :label="t('Promotion.dateWorth')"
              name="dateWorth"
              disabled
              v-model="Promotion.Employee.dateNextPromotion"
            />
          </ICol>
          <ICol span="1" span-md="1" span-sm="1">
            <IInput
              :label="t('Promotion.numberLastPromotion')"
              name="numberLastPromotion"
              disabled
              v-model="Promotion.Employee.numberLastPromotion"
              :type="EnumInputType.Text"
            />
          </ICol>
          <ICol span="1" span-md="1" span-sm="1">
            <IInput
              :label="t('Promotion.DegreeStage')"
              name="degreeStage"
              disabled
        ...
        <IRow col-lg="4" col-md="2" col-sm="1">
          <ICol span="1" span-md="2" span-sm="4">
            ...
            <vSelect
              ...
              v-model="Promotion.Employee"
              :options="PromotionStore.Employees"
            ...
            >
              <template #option="{ name }">
                <div>
                  <span class="text-right dark:text-textLight dark:bg-input">{{
                    name
                  }}</span>
                </div>
              </template>
          ...
          <ICol span="1" span-md="2" span-sm="4">
            ...
            <vSelect
              ...
              v-model="Promotion.DegreeStage"
              :options="PromotionStore.DegreeStages"
          ...
          <ICol span="1" span-md="1" span-sm="1">
            <IInput
              :label="t('Date')"
              name="issueDate"
              v-model="Promotion.issueDate"
              :type="EnumInputType.Date"
            />
          </ICol>
          <ICol span="1" span-md="1" span-sm="1">
            <IInput
              :label="t('Promotion.number')"
              name="number"
              v-model="Promotion.number"
              :type="EnumInputType.Text"
            />
          </ICol>
        </IRow>
        <IRow>
          <ICol span="1" span-md="1" span-sm="1">
            ...
            <textarea
              ...
              :label="t('Promotion.notes')"
              v-else
              name="notes"
              v-model="Promotion.notes"
            ></textarea>
          </ICol>
        </IRow>
      </IRow>
