  ...
  <IPage :HeaderTitle="t('Backup.Restore')">
    <template #HeaderButtons>
      ...
      <IButton
        ...
        :onClick="cancel"
        :text="t('Cancel')"
        class="ms-2 bg-gray-500 hover:bg-gray-600"
      />
    </template>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="flex">
              ...
              <div class="me-3">
                ...
                <p class="mt-2 text-sm text-red-700">
                  عملية الاستعادة ستستبدل البيانات الحالية بالبيانات من النسخة
                  الاحتياطية. هذا الإجراء لا يمكن التراجع عنه.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              >
                <div>
                  <label class="font-medium text-gray-700"
                    >استعادة قاعدة البيانات</label
                  >
                  <p class="text-sm text-gray-500">
                    استعادة جميع بيانات قاعدة البيانات
                  </p>
                </div>
                <input
                  type="checkbox"
              ...
              >
                <div>
                  <label class="font-medium text-gray-700"
                    >استعادة الملفات</label
                  >
                  <p class="text-sm text-gray-500">
                    استعادة جميع الملفات والمجلدات
                  </p>
                </div>
              ...
              >
                <div>
                  <label class="font-medium text-gray-700"
                    >التحقق من Checksum</label
                  >
                  <p class="text-sm text-gray-500">
                    التأكد من سلامة الملفات قبل الاستعادة
                  </p>
                </div>
                <input
                  type="checkbox"
          ...
          <div class="flex justify-end gap-4 mt-8">
            ...
            <button
              ...
              :disabled="isRestoring || (!restoreDatabase && !restoreFiles)"
            >
