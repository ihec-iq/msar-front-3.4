        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="flex">
              ...
              <div class="me-3">
                ...
                <p class="mt-2 text-sm text-red-700">
                  عملية الاستعادة ستستبدل البيانات الحالية بالبيانات من النسخة الاحتياطية. هذا الإجراء لا يمكن التراجع
                  عنه.
                </p>
              </div>
            </div>
          ...
          <div class="space-y-6">
            <div>
              ...
              <input type="text" :value="backupPath" disabled
          ...
          <div class="flex justify-end gap-4 mt-8">
            <button @click="cancel" class="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50"
