...
<template>
  <div>
    <div class="mb-6">
      <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-300">الإعدادات العامة</h2>
      <p class="text-gray-600 mt-1 dark:text-gray-400">التحكم في النظام الأساسي للنسخ الاحتياطي</p>
    </div>
