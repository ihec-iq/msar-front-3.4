  ...
  <div>
    <div class="mb-6">
      ...
      <p class="text-gray-600 mt-1 dark:text-gray-400">
        التحكم في إشعارات حالة النسخ الاحتياطي
      </p>
    </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex-1">
          ...
          <p class="text-sm text-gray-500 mt-1">
            إرسال إشعارات عن حالة النسخ الاحتياطي
          </p>
        </div>
    ...
    <div v-if="formData.notify_enabled" class="space-y-4">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  v-model="formData.notify_on_success"
                  class="sr-only peer"
                />
                <div
                  class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] rtl:after:end-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"
            ...
            >
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  v-model="formData.notify_on_failure"
                  class="sr-only peer"
                />
                <div
                  class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] rtl:after:end-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"
            ...
            >
              <div class="flex-1">
                <label class="text-sm font-medium text-gray-700"
                  >إشعار المسؤولين</label
                >
                <p class="text-xs text-gray-500 mt-0.5">
                  إرسال إشعارات للمسؤولين المسجلين
                </p>
              </div>
              <label class="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  v-model="formData.notify_admins"
                  class="sr-only peer"
                />
                <div
                  class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] rtl:after:end-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"
        ...
        <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <label class="block font-medium text-gray-900 mb-3"
            >عدد الساعات للإشعار بالتأخير</label
          >
          <input
            type="number"
      ...
      <!-- Email Notifications -->
      <EmailNotifications v-model:formData="formData" />
      ...
      <WebhookNotifications v-model:formData="formData" />
    </div>
  </div>
</template>
