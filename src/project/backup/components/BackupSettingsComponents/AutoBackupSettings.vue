  ...
  <div>
    <div class="mb-6 pt-6 border-t border-gray-200">
      ...
      <p class="text-gray-600 mt-1 dark:text-gray-400">
        جدولة النسخ التلقائي بفترات محددة
      </p>
    </div>
      ...
      <div class="flex items-center justify-between">
        <div class="flex-1">
          ...
          <p class="text-sm text-gray-500 mt-1">
            تشغيل نسخ احتياطية دورية تلقائياً
          </p>
        </div>
        <label class="relative inline-flex items-center cursor-pointer">
          <input
            type="checkbox"
            v-model="formData.auto_backup_enabled"
            class="sr-only peer"
          />
          <div
    ...
    <div v-if="formData.auto_backup_enabled" class="space-y-4">
      ...
      <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <label class="block font-medium text-gray-900 mb-4"
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
          ...
          <label
            class="relative flex items-center p-3 bg-gray-50 border-2 rounded-lg cursor-pointer transition-all hover:border-blue-300"
            :class="
              ![60, 360, 720, 1440, 10080].includes(
                formData.auto_backup_interval
              )
                ? 'border-blue-500 bg-blue-50'
                : 'border-gray-200'
            "
      ...
      <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
          <label
            ...
            :class="
              formData.auto_backup_type === type.value
                ? 'border-blue-500 bg-blue-50'
                : 'border-gray-200'
            "
          >
            <input
              type="radio"
              :value="type.value"
              v-model="formData.auto_backup_type"
              class="sr-only"
            />
            <div class="flex-1">
              <div class="text-sm font-semibold text-gray-900">
      ...
      <div
        v-if="formData.last_auto_backup_at"
        ...
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <div class="text-xs text-gray-500">
              {{ timeAgo(formData.last_auto_backup_at) }}
            </div>
          </div>
        </div>
      </div>
