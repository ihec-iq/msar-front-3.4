    ...
    <section class="text-white md:bg-black">
      <div class="vi-bg">
        <video
          ...
          class="fixed w-full"
        ></video>
        <!-- md:h-5/6 md:w-11/12 screen -->
        <img
          src="@/assets/image/avatar-2.png"
          class="absolute op-0 right-0 bottom-0"
        />
      </div>
      <div
        class="px-4 py-32 mx-auto max-w-screen-xl h-screen items-center flex"
      >
        <div class="max-w-3xl mx-auto text-center z-10">
          <h1
            class="text-3xl drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] animate-pulse font-extrabold text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-[white] via-[black] to-[white]"
          >
            نظام سير العمل
          ...
          <div class="flex flex-wrap justify-center mt-8 gap-4">
            <router-link to="/login">
              <a
                ...
                "
              >
                <span class="font-bold text-2xl"> ابدأ </span>
              </a>
            </router-link>
          </div>
        </div>
