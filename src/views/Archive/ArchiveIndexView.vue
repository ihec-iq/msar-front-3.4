...
<template>
  ...
  <div class="flex">
    ...
    <div class="lg:w-[95%] mb-12 lg:ml-[5%] xs:w-full md:mr-[2%]">
      ...
      <div class="collapse container-main m-2">
        <input type="checkbox" />
      ...
      <div class="w-full">
        <div class="flex flex-col">
          <div class="py-4 inline-block min-w-full lg:px-8" id="PageDataStart">
            <!-- card -->
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="dropdown">
                        ...
                        <ul
                          class="dropdown-menu top-8 peer-hover:block hover:block min-w-max absolute text-base z-50 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 hidden m-0 bg-clip-padding border-none dark:bg-gray-800 bg-white"
