<template>
  <!-- <Form :validation-schema="schema" v-slot="{ errors }">
    <Field name="email" v-model="frm.email" />
    <p>{{ errors.email }}</p>
    <Field name="password" v-model="frm.password" type="password" />
    <p>{{ errors.password }}</p>
  ...
  <section class="wrapper">
    <div class="container">
      <div id="scene" class="scene" data-hover-only="false">
        ...
        <p class="p404 cursor-default" data-depth="0.50">404</p>
        <p class="p404 cursor-default" data-depth="0.10">404</p>
      </div>
...
//     return "This field is must be greater then " + length;
//   }
//   return true;
// });
...
// };
// const frm = reactive<{ email: string; password: string }>({
//   email: "aaaa@aaa.com",
//   password: "123321",
// });
</script>
