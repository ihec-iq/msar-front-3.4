      ...
      <CardBody
        ...
        <div
          ...
          <div class="text-center">
            <img class="h-24 mx-auto" src="@/assets/logo.png" alt="MSAR ERP LOGO" />
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ليس لديك حساب؟
              <a href="/" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-300">انشاء حساب
                →</a>
            </p>
          </div>
          <Form class="space-y-6 mt-8" v-if="isLoading == false" :initial-values="loginForm" @submit="onSubmit"
            ...
            <div class="flex items-center justify-center mt-3 border border-red-600 p-4 rounded-lg" v-if="errs != ''">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <label for="remember" class="ml-2 block text-sm text-gray-900 dark:text-gray-300 p-2">تذكرني</label>
              </div>
              <div class="text-sm">
                <a href="" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-300">نسيت كلمة
                  المرور؟</a>
              </div>
              <div class="text-sm">
                <a href="" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-300">
                  v{{ version }}
                </a>
              </div>
            </div>
