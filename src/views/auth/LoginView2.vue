...
<template>
    ...
    <div class="p-12  max-lg:p-4 flex justify-center items-center">
        <GlowBorder
            class="relative flex mt-15 md:w-1/2 w-full flex-col items-center justify-center overflow-hidden rounded-lg   bg-background md:shadow-xl"
            ...
            <div
                ...
                <Form class="space-y-6 mt-8" v-if="isLoading == false" :initial-values="loginForm" @submit="onSubmit"
                    ...
                    <div>
                        <button type="submit"
                            class="     rounded-md shadow-sm focus:outline-dotted focus:ring-2 focus:ring-offset-2 px-4 py-2 text-base bg-black font-medium text-white hover:bg-gray-800 border border-black focus:ring-black w-full justify-center">دخول</button>
                    </div>
                </Form>
