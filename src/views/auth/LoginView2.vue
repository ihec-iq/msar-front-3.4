            ...
            <CardBody
                ...
                <div
                    ...
                    <div class="text-center">
                        <img class="h-24 mx-auto" src="@/assets/logo-512x512.png" alt="Apple">

                        <span
                            className=" whitespace-pre-wrap bg-gradient-to-b from-black to-gray-300/80 bg-clip-text text-center text-4xl font-semibold leading-none text-transparent dark:from-white dark:to-zinc-700/75">
                            تسجيل الدخول
                        </span>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            ليس لديك حساب؟
                            <a href="/"
                                class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-300">انشاء
                                حساب
                                →</a>
                        </p>
                    </div>
                    <Form class="space-y-6 mt-8" v-if="isLoading == false" :initial-values="loginForm"
                        ...
                        <TextInput v-model="loginForm.email" name="email" type="email" :label="t('E-mail')"
                            :placeholder="t('Your Email Address')" errors-message="ادخل الاميل او اسم الحساب" />
                        <TextInput v-model="loginForm.password" name="password" type="password" :label="t('Password')"
                            :placeholder="t('Your password')" errors-message="رمز الحساب لا يجب ان يقل عن حرفين" />
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm ">
                                <a href=""
                                    class="font-medium  text-indigo-600 hover:text-indigo-500 dark:text-indigo-300">نسيت
                                    كلمة
                                    المرور؟</a>
                            </div>
                        </div>
                        ...
                        <div>
                            <button type="submit"
                                class="rounded-md 
                               shadow-sm focus:outline-dotted focus:ring-2
                              focus:ring-offset-2 px-4 py-2 text-base bg-black font-medium
                              text-white hover:bg-gray-800 border border-black focus:ring-black w-full justify-center">دخول</button>
                        </div>
                    </Form>
