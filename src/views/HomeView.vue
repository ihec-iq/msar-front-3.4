...
<template>
  <div class="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 p-4">
    <router-link
      ...
      >
        ...
        >
          ...
          >
            <div
              title="Feature"
              class="dark:text-navIconColorHoverDark dark:hover:text-navIconColoDark flex flex-auto content-around hover:text-navIconColoDark text-[#444] p-4 justify-center rounded-md smooth-hover"
            >
              <span v-html="Link.iconX" class="dark:text-content ml-3"></span>
              <h2
                class="mt-4 text-xl font-medium sm:text-2xl dark:text-content dark:hover:text-navIconColoDark text-[#444]"
              >
                {{ Link.title }}
              </h2>
            </div>
...
@/stores/permissionStore@/project/user/permissionStore@/utilities/I18nPlugin