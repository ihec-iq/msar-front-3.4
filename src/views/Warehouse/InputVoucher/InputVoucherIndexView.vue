                        ...
                        <div class="ltr:ml-2 rtl:mr-2 ltr:text-left rtl:text-right">
                          ...
                          <div class="text-text dark:text-textGray mb-2 justify-between">
                            ...
                            <span class="float-left flex" title="Items count">
                              {{ item.itemsCount }}
                              <svg title="Items count" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                viewBox="0 0 24 24">
...
@/stores/voucher1/inputVoucher@/stores/voucher1/inputVoucher@/stores/permissionStore@/stores/warehouse/inputVoucher
