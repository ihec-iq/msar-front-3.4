      ...
      >
        <div class="flex flex-col justify-start w-1/4 space-y-4">
          ...
          <a
            class="px-4 py-2 text-sm"
            :class="{
              'z-20 transform translate-x-2 border-l-2 border-blue-500 font-bold':
                tab === 2,
        ...
        <div class="w-3/4">
          <div class="space-y-6" v-if="tab === 1">
            <h3
            ...
            <p
              ...
              x-transition:enter-start="opacity-0"
            >
              Batman & Robin try to keep their relationship together even as
              they must stop Mr. Freeze and Poison Ivy from...
            </p>
            <p
              class="text-base"
            ...
            <a
              href="https://twitter.com/smilesharks"
          ...
          <div class="space-y-6" v-if="tab === 2">
            <h3
              class="text-xl font-bold leading-tight"
              x-transition:enter="transition duration-500 transform ease-in"
              x-transition:enter-start="opacity-0"
            ...
            <p
              ...
              x-transition:enter-start="opacity-0"
            >
              Batman (Ben Affleck) and Superman (Henry Cavill) share the screen
              in this Warner Bros./DC Entertainment co-production penned by
              David S....
            </p>
            <p
              class="text-base"
          ...
          <div class="space-y-6" v-if="tab === 3">
            <h3
              class="text-xl font-bold leading-tight"
              x-transition:enter="transition duration-500 transform ease-in"
              x-transition:enter-start="opacity-0"
          ...
          <div class="space-y-6" v-if="tab === 4">
            <h3
              class="text-xl font-bold leading-tight"
              x-transition:enter="transition duration-500 transform ease-in"
              x-transition:enter-start="opacity-0"
            ...
            <p
              ...
              x-transition:enter-start="opacity-0"
            >
              Fathom Events, Warner Bros. and DC Comics invite you to a premiere
              event when Batman: The Killing Joke comes to...
            </p>
            <p
              class="text-base"
              x-transition:enter="transition delay-300 duration-500 transform ease-in"
          ...
          <div class="space-y-6" v-if="tab === 5">
            <h3
              class="text-xl font-bold leading-tight"
              x-transition:enter="transition duration-500 transform ease-in"
              x-transition:enter-start="opacity-0"
