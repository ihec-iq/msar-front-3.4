...
type ButtonColor =
  "blue" | "green" | "amber" | "red" | "white" | "gray" | "slate";
...
const effectiveVariant = computed<EnumButtonType>(
...
<template>
  ...
  >
    ...
    <slot name="leading">
      <Icon
        v-if="normalizedPreIcon"
        :icon="normalizedPreIcon"
        :class="iconClass"
      />
    </slot>
    ...
    <slot name="trailing">
      <Icon
        v-if="normalizedPostIcon"
        :icon="normalizedPostIcon"
        :class="iconClass"
      />
    </slot>
