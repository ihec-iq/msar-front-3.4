...
<template>
  <div
    class="bg-cardLight btn dark:bg-card overflow-hidden hover:bg-gray-300 dark:hover:bg-gray-800 rounded-sm border-gray-300 shadow-sm shadow-gray-400 duration-500 hover:border-0 hover:border-gray-200 hover:shadow-md hover:shadow-gray-200 mb-2"
  >
    <button
