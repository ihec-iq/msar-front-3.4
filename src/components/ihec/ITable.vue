...
<template>
  <div class="table-container">
    ...
    <div class="mb-4 flex flex-wrap justify-between items-center gap-4">
      ...
      <div class="flex gap-2">
        <button
          ...
          @click="exportToExcel"
          class="bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
        >
          <svg
            class="w-4 h-4"
            fill="none"
        ...
        <button
          ...
          @click="printTable"
          class="bg-blue-500 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-all duration-200 hover:shadow-lg transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
        >
          <svg
            class="w-4 h-4"
            fill="none"
    ...
    <!-- No Data Message -->
    <div
      v-if="!props.items.length && props.showNoData"
      class="text-center mt-8 py-8 text-gray-500 dark:text-gray-400"
    >
      <div class="text-lg">{{ t("noData") || "No data available" }}</div>
    </div>
