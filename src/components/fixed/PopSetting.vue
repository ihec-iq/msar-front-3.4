...
<template>
  <div class="flex items-center">
    <button
      @click="openPopup"
      class="mx-2 rounded-md text-iconLight hover:text-iconHoverLight dark:text-textGray dark:hover:text-iconHover bg-transparent transition duration-200"
  ...
  <van-popup
    ...
    class="bg-customer dark:bg-content w-full sm:w-[80%] md:w-[50%] lg:w-[35%] xl:w-[30%] h-screen flex flex-col justify-between overflow-hidden z-[999999] rounded-t-xl"
    round
    lock-scroll
  >
    <!-- Header -->
    ...
    <!-- Body -->
    <div
      class="flex-1 overflow-y-auto py-4 space-y-6 px-6 text-text dark:text-textLight"
    >
      <!-- Theme -->
    ...
    <!-- Footer -->
    <div
      class="flex justify-between gap-3 p-4 border-t border-gray-300 dark:border-gray-700"
    >
      <button
        @click="
          $router.push('/config');
