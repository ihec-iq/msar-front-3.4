...
import { DashboardLinks } from "@/project/dashboard/DashboardLinks";
...
export const Links: Array<IconLink> = [
  {
    ...
    tab: "Home",
    description:
      "البوابة الاساسية للنظام ومن خلالها تستطيع الدخول الى كافة  خدمات النظام",
    permissions: [],
    isActive: true,
  },
  ...DashboardLinks,
