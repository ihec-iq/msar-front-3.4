...
<template>
  <div
    class="print:hidden flex text-gray-800 dark:bg-[#26293B] max-h-14 bg-navLight box-border mx-0 flex-1 items-center p-1 justify-between dark:border-b dark:border-gray-800 shadow-md sm:px-1 xs:w-full"
    id="toolbar"
  >
    <VersionChecker />
    ...
    <div
      class="relative w-56 duration-500 ease-in-out max-w-md mx-auto"
