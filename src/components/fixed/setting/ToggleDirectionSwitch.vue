...
watch(
  [() => props.checked, () => props.rtlLabel, () => props.ltrLabel],
  measure,
  { immediate: true }
);
...
<template>
  ...
  >
    ...
    <span
      class="absolute rounded-full bg-white dark:bg-neutral-100 shadow transition-transform duration-200 grid place-items-center"
      :style="knobStyle"
    >
      <Icon
        :icon="
